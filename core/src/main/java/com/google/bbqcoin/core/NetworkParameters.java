...
import static com.google.bbqcoin.core.Utils.COIN;
import static com.google.common.base.Preconditions.checkState;

/**
 * <p>NetworkParameters contains the data needed for working with an instantiation of a Bbqcoin chain.</p>
 *
 * Currently there are only two, the production chain and the test chain. But in future as Bbqcoin
...
public class NetworkParameters implements Serializable {
    ...
    public static final String ID_PRODNET = "org.bbqcoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.bbqcoin.test";
    /** Unit test network. */
    static final String ID_UNITTESTNET = "com.google.bbqcoin.unittest";
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all Bbqcoin implemenetations. For a
    ...
    private NetworkParameters(int type) {
        ...
        if (type == 0) {
            ...
            checkState(genesisHash.equals("32e21aeb3780622102419fbda3a5f9d6c8d81d52e3d1b6cdad8a8e92f50415ec"),
                    genesisHash);
    ...
    public static final int TARGET_TIMESPAN = (int)(60 * 60);  // BBQ 1 Hour Difficulty Cycle
    public static final int TARGET_SPACING = (int)(60);  // BBQ 1 Minute Block Time
    ...
    /** The primary Bbqcoin chain created by Satoshi. */
    ...
    /** The primary Bbqcoin chain created by Hank. */
