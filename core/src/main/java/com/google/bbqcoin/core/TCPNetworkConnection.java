...
/**
 * <p>A {@code TCPNetworkConnection} is used for connecting to a Bbqcoin node over the standard TCP/IP protocol.<p>
 *
...
public class TCPNetworkConnection implements NetworkConnection {
    ...
    private BbqcoinSerializer serializer = null;
    ...
    public TCPNetworkConnection(NetworkParameters params, VersionMessage ver) {
        ...
        this.serializer = new BbqcoinSerializer(this.params);
    ...
    private void onVersionMessage(Message m) throws IOException, ProtocolException {
        ...
        // bbqcoinj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public class NetworkHandler extends ReplayingDecoder<VoidEnum> implements ChannelDownstreamHandler {
        ...
        // Attempt to decode a Bbqcoin message passing upstream in the channel.
        //
        ...
        /** Serialize outgoing Bbqcoin messages passing downstream in the channel. */
    ...
    /** Returns the Netty Pipeline stage handling Bbqcoin serialization for this connection. */
