...
public class TransactionOutput extends ChildMessage implements Serializable {
    ...
    // These fields are Java serialized but not Bbqcoin serialized. They are used for tracking purposes in our wallet
    ...
    */
    ...
    public String toString() {
        try {
            return "TxOut of " + Utils.bbqcoinValueToFriendlyString(value) + " to " + getScriptPubKey().getToAddress()
