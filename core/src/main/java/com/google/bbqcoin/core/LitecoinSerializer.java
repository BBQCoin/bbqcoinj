...
/**
 * <p>Methods to serialize and de-serialize messages to the Bbqcoin network format as defined in
 * <a href="https://en.bbqcoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.bbqcoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class BbqcoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(BbqcoinSerializer.class);
    ...
    /**
     * Constructs a BbqcoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public BbqcoinSerializer(NetworkParameters params) {
     ...
     */
    public BbqcoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("BbqcoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        ...
        byte[] payload = message.bbqcoinSerialize();
    ...
    public Message deserialize(InputStream in) throws ProtocolException, IOException {
        // A Bbqcoin protocol message has the following format.
        //
        ...
        BbqcoinPacketHeader header = new BbqcoinPacketHeader(in);
     ...
     */
    public BbqcoinPacketHeader deserializeHeader(InputStream in) throws ProtocolException, IOException {
        return new BbqcoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link BbqcoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(BbqcoinPacketHeader header, InputStream in) throws ProtocolException, IOException {
        int readCursor = 0;
    ...
    public static class BbqcoinPacketHeader {
        public final byte[] header;
        public final String command;
        public final int size;
        public final byte[] checksum;

        public BbqcoinPacketHeader(InputStream in) throws ProtocolException, IOException {
