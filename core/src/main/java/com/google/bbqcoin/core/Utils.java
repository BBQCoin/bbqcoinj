...
/**
 * A collection of various utility methods that are helpful for working with the Bbqcoin protocol.
 * To enable debug logging from the library, run with -Dbbqcoinj.logging=true on your command line.
 */
public class Utils {
    ...
    /** The string that prefixes all text messages signed using Bbqcoin keys. */
    public static final String LITECOIN_SIGNED_MESSAGE_HEADER = "Bbqcoin Signed Message:\n";

    // TODO: Replace this nanocoins business with something better.

    /**
     * How many "nanocoins" there are in a Bbqcoin.
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using Bbqcoin.
    ...
    /**
     * How many "nanocoins" there are in 0.01 Bbqcoins.
     * <p/>
     * A nanocoin is the smallest unit that can be transferred using Bbqcoin.
     * The term nanocoin is very misleading, though, because there are only 100 million
     * of them in a coin (whereas one would expect 1 billion).
     ...
     * standard procedure in Bbqcoin. The resulting hash is in big endian form.
     */
     ...
     */
    public static String bbqcoinValueToFriendlyString(BigInteger value) {
     ...
     */
    public static String bbqcoinValueToPlainString(BigInteger value) {
        if (value == null) {
     ...
     *
     * <tt><p>[24] "Bbqcoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
