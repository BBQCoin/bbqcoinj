...
/**
 * <p>A BlockChain implements the <i>simplified payment verification</i> mode of the Bbqcoin protocol. It is the right
...
public class BlockChain extends AbstractBlockChain {
     ...
     * </p>
     *
     * <p>For the store, you should use {@link com.google.bbqcoin.store.SPVBlockStore} or you could also try a
     * {@link com.google.bbqcoin.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
