 ...
 * Currently this includes getaddr, ping, verack as well as the special bbqcoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void bbqcoinSerializeToStream(OutputStream stream) throws IOException {
    }
